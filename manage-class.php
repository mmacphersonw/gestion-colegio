    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title"> Gestionar Año </h3>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active" aria-current="page"> Gestionar Año</li>
            </ol>
          </nav>
        </div>
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-sm-flex align-items-center mb-4">
                  <h4 class="card-title mb-sm-0"> Gestionar Año</h4>
                  <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Ver todos los años</a>
                </div>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th class="font-weight-bold">Nombre del Año</th>
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) {               ?>
                          <tr>
                            ...
                            <td><?php echo htmlentities($row->Sección); ?></td>
                            ...
                            <td>
                              ...
                              <a href="manage-class.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Deseas eliminar este registro?');" class="btn btn-danger btn-sm"> <i class="icon-trash"></i></a>
                            </td>
                          </tr><?php $cnt = $cnt + 1;
                              }
                            } ?>
