                  ...
                  if ($query->rowCount() > 0) {
                    foreach ($results as $row) {               ?>
                      ...
                      <div class="form-group">
                        ...
                        <img src="assets/images/<?php echo $row->Image; ?>" width="100" height="100" value="<?php echo $row->Image; ?>">
                      </div>
                      <h3>Padres / Acudientes</h3>
                      <div class="form-group">
