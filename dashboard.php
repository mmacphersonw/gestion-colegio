...
?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="d-sm-flex align-items-baseline report-summary-header">
                      <h5 class="font-weight-semibold">Reporte</h5> <span class="ml-auto">Reporte Actualizado</span> <button class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></button>
                    </div>
                  </div>
                </div>
                <div class="row ">
                  <div class=" col-md-6 report-inner-cards-wrapper">
                    <div class="report-inner-card color-2">
                      <div class="inner-card-text text-white">
                        ...
                        ?>
                        <span class="report-title">Total de Años</span>
                        <h4><?php echo htmlentities($totclass); ?></h4>
                        <a href="manage-class.php"><span class="report-count"> Ver Años</span></a>
                      </div>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Resumen de Actividades Diarias'
      };
