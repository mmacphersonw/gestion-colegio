            ...
            <div class="card">
              <div class="card-body">
                <div class="d-sm-flex align-items-center mb-4">
                  ...
                  <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Ver Noticias</a>
                </div>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th class="font-weight-bold">Año</th>
                        <th class="font-weight-bold">Sección</th>
                        <th class="font-weight-bold">Fecha Noticia</th>
                        ...
                        foreach ($results as $row) {               ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="manage-notice.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Deseas eliminar este registro?');" class="btn btn-danger btn-sm"> <i class="icon-trash"></i></a>
                            </td>
                          </tr><?php $cnt = $cnt + 1;
                              }
                            } ?>
