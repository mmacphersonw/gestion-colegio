    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title"> Búsqueda de Estudiantes </h3>
              ...
              <div class="card-body">
                <form method="post">
                  <div class="form-group">
                    ...
                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Búsqueda por ID de Estufdiante">
                  </div>

                  <button type="submit" class="btn btn-primary" name="search" id="submit">Búsqueda</button>
                </form>
                <div class="d-sm-flex align-items-center mb-4">
                  ...
                  ?>
                    <h4 align="center">Resultados por "<?php echo $sdata; ?>" palabra clave </h4>
                </div>
