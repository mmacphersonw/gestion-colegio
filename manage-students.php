                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th class="font-weight-bold">Fecha de Ingreso</th>
                        ...
                        foreach ($results as $row) {               ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="manage-students.php?delid=<?php echo ($row->sid); ?>" onclick="return confirm('Deseas eliminar este registro?');" class="btn btn-danger btn-sm"> <i class="icon-trash"></i></a>
                            </td>
                          </tr><?php $cnt = $cnt + 1;
                              }
                            } ?>
